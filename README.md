...
<details>
<summary><strong>YouTube</strong> — 58 patches (20.45.36, 20.44.38, 20.40.45, 20.31.42, 20.21.37)</summary>
...
| Custom branding | Adds options to change the app icon and app name. |
...
| Downloads | Adds support to download videos with an external downloader app. |
...
| GmsCore support | Allows the app to work without root by using a GmsCore instead of Google Play Services. |
...
| Navigation bar | Adds options to hide and change the bottom navigation bar and the upper navigation toolbar. |
...
| Playback speed | Adds options to customize available playback speeds, set a default, and show a speed dialog button. |
| Reload video | Adds options to display buttons in the video player to reload video. |
...
| Remove viewer discretion dialog | Adds an option to automatically accept the age-restriction dialog. Does not bypass the restriction. |
...
| Seekbar | Adds options for seekbar behavior: disable precise seeking, slide to seek, tap to seek, and hide seekbar. |
| Shorts autoplay | Adds options to automatically play the next Short. |
| SponsorBlock | Adds options to enable and configure SponsorBlock, which can skip undesired video segments. |
| Spoof app version | Adds an option to trick YouTube into thinking you are running an older version of the app. |
...
| Theme | Adds options for theming and applies a custom background theme. |
...
<details>
<summary><strong>YouTube Music</strong> — 24 patches (8.44.54, 8.40.54, 8.10.52, 7.29.52)</summary>
...
| Sanitize sharing links | Removes the tracking query parameters from shared links. |
| Theme | Adds options for theming and applies a custom background theme. |
| **Track crossfade** ✦ | True dual-player crossfade with configurable duration, fade curves, session control, and auto-advance via `playNextInQueue`. By [VazerOG](https://github.com/VazerOG). |

</details>

<details>
<summary><strong>Reddit</strong> — 13 patches (2026.04.0, 2026.03.0, 2025.48.0)</summary>
...
<details>
<summary><strong>All apps</strong> — 3 universal patches</summary>

| Patch | Description |
|-------|-------------|
| Change package name | Appends ".morphe" to the package name by default. |
